  ...
  return (
    <nav className="bg-blue-600 text-white shadow-md">
      <div className="container mx-auto flex justify-between items-center px-6 py-4">
        ...
        <div 
          className={`md:flex md:items-center md:space-x-4 absolute z-10 md:static top-14 left-0 w-full md:w-auto bg-blue-600 transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 md:block`}
        >
